...
public class Question1 {
	public static void main(String[] args){
		...
		case 1:
		{
			...
			ECE ece = new ECE();
			String a  = ece.displayCourseDetails("ECE");
			System.out.println(a);//call the function of the class that you initialized
			break;
		}
		case 2:
		{
			...
			String a  = Mech.displayCourseDetails("Mechanical");
			System.out.println(a);//call the function of the class that you initialized
			break;
		}
		case 3:
		{
			...
			//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			CSE cse = new CSE();
			String a  = cse.displayCourseDetails("CSE");
			System.out.println(a);//call the function of the class that you initialized
			break;
		}
		default:
